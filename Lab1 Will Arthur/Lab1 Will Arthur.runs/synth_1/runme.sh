...
HD_PWD='C:/Users/Student/Will Arthur Jimmy CS m152b/Lab1 Will Arthur/Lab1 Will Arthur.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log m16_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source m16_1.tcl
