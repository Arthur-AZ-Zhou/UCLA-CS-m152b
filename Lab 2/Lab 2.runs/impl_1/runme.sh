...
HD_PWD='C:/Users/Student/Will Arthur Jimmy CS m152b/Lab 2/Lab 2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TrafficController.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TrafficController.tcl -notrace
