...
HD_PWD='C:/Users/Student/Will Arthur Jimmy CS m152b/Lab 2/Lab 2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TrafficController.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TrafficController.tcl
